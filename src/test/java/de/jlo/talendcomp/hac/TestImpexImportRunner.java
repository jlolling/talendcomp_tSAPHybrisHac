...
public class TestImpexImportRunner {
	...
	String impexHeader = "$catalogVersion=catalogversion(catalog(id[default='my_vendorproductcatalog']),version[default='Online'])[unique=true]\n"
		    ...
		    + "        INSERT_UPDATE Product;vendorSku;code[unique=true];name[lang=en];name[lang=de];displayName[lang=en];displayName[lang=de];description[lang=en];description[lang=de];summary[lang=en];summary[lang=de]; unit(code); alternateSellingUnits(code); priceUnit(code);$supercategories[vendor=$vendor][globalCatalogId='globalMarketplaceProductCatalog'][globalCatalogVersion='Online'][translator=de.hybris.platform.marketplaceservices.dataimport.batch.translator.MarketplaceCategoryTranslator];@thickness_my_vendor[$feature];@width[$feature];@length[$feature];@lengthCoil[$feature];@weight_my_vendor[$feature];@lengthCut_my_vendor[$feature];@rangemy_vendor[$feature];@gradeEN[$feature];@finish[$feature];@gradeASTM[$feature];@standardsApproval[$feature];@surface[$feature];@my_vendor_surfaceProtection[$feature];@interleavingPaper[$feature];@marking[$feature];@aproxnumberSheet[$feature];sequenceId[translator=de.hybris.platform.acceleratorservices.dataimport.batch.converter.SequenceIdTranslator];$catalogVersion;$approved;vendors(code)[default=$vendor];deliveryRegions(vendor(code),code)[default=$vendor:default];leadTime;$variantType;@my_vendor_certificate_3_1[$feature, default=TRUE];\n";

	String impexData = ";;\"best_steel_T3.0_W1000-L2000_2B_with_interleaving_paper\";\"my_vendor_best_steel_T3.0_W1000-L2000_2B_with_interleaving_paper\";;;;;;;;;\"PK\";;\"KGM\";\"my_vendor_stockSheets\";\"3.0\";1000;2000;;1000;;\"rangemy_vendor_Core\";\"4307\";\"finish_2B\";\"gradeASTM_304,gradeASTM_304L\";\"standardsApproval_EN_10028_7,standardsApproval_EN_10088_2, standardsApproval_EN_10088_4\";;\"foiling_no\";\"interleavingPaper_yes\";\"marking_yes\";;;;\"approved\";;;2";
	...
	public void testMatch2() {
		String errorLine = ImpexImportRunner.crunch(",8806844104705,,,column 3: cannot resolve value 'my_vendor-1D-scaled' for attribute 'galleryImages';<ignore>my_vendor_best_steel_T3.0_W1500_1D_295225_cuttable-l;<ignore>/ProductImageUploadFormat/my_vendor-1D-scaled.png;my_vendor-1D-scaled;<ignore>");
		String dataLine = ImpexImportRunner.crunch(";\"my_vendor_best_steel_T3.0_W1500_1D_295225_cuttable-l\";\"/ProductImageUploadFormat/my_vendor-1D-scaled.png\";\"my_vendor-1D-scaled\"");
		System.out.println(errorLine);
		System.out.println(dataLine);
		if (errorLine.contains(dataLine) == false) {
			assertTrue(false);
	...
	public void testCheckDuplicates() {
		String dataLine1 = ";\"my_vendor_best_steel_T3.0_W1500_1D_295225_cuttable-l\";\"/ProductImageUploadFormat/my_vendor-1D-scaled.png\";\"my_vendor-1D-scaled\"";
		String dataLine2 = ";\"my_vendor_best_steel_T3.0_W1500_1D_295225_cuttable-l\";\"/ProductImageUploadFormat/my_vendor-1D-scaled.png\";\"my_vendor-1D-scaled\"";
		String dataLine3 = ";\"my_vendor_best_steel_T3.0_W1500_1D_295226_cuttable-l\";\"/ProductImageUploadFormat/my_vendor-1D-scaled.png\";\"my_vendor-1D-scaled\"";
		ImpexImportRunner r = new ImpexImportRunner();
	...
	String impexVariantProductHeader = "$catalogVersion=catalogversion(catalog(id[default='my_vendorproductcatalog']),version[default='Online'])[unique=true]\n"
			+ "        $approved=approvalstatus(code)[default='approved']\n"
			+ "        $taxGroup=Europe1PriceFactory_PTG(code)[default=eu-vat-full]\n"
			+ "        $supercategories=supercategories(code,catalogversion(catalog(id[default='globalMarketplaceProductCatalog']),version[default='Online']))\n"
			+ "        $lang=en\n"
	...
	String impexVariantProductData = ";\"4404_Supra_T4.0_W1250-L2500_2B_321475\";\"my_vendor_4404_Supra_T4.0_W1250-L2500_2B_321475\";\"Supra 316L/4404 - 2B sheet\";\"Supra 316L/4404 - 2B Blech\";\"<span style=\"\"color: #306084\"\">Supra 316L/4404</span> <br/> <span style=\"\"color: #306084\"\"> </span>\";\"<span style=\"\"color: #306084\"\">Supra 316L/4404</span> <br/> <span style=\"\"color: #306084\"\"> </span>\";\"<p>Exact delivery cost will be shown in checkout-process and depends on order quantity</p><p><strong>Outokumpu Supra Range</strong></p> <ul> Stainless steels for highly corrosive environments (PRE 22 to 27) Austenitics are highly formable and weldable and used in claddings, storage tanks, and heat exchangers. Includes the well-known Outokumpu Supra 316L/4404 as well as several alternatives. Ferritic stainless steels are nickel free, have good formability, and can be used in applications with elevated temperatures <iframe width=\"\"640\"\" height=\"\"360\"\" src=\"\"https://www.youtube.com/embed/1Zt7e8vYEZc\"\" frameborder=\"\"0\"\" allow=\"\"autoplay; encrypted-media\"\" allowfullscreen></iframe>\"\"\";\"<p>Genauer Lieferpreis wird im Checkout-Prozess angezeigt und h&auml;ngt von Bestellmenge ab</p> <p><strong>Outokumpu Supra Kategorie</strong></p> <ul> F&uuml;r stark korrosive Umgebungen (PRE 22 bis 27). Enth&auml;lt den bekannten Outokumpu Supra 316L/4404 sowie verschiedene Alternativen. Austenitische G&uuml;ten sind ausgezeichnet form- und schwei&szlig;bar und werden f&uuml;r Verkleidungen, Lagerbeh&auml;lter und W&auml;rmeaustauscher verwendet. Ferritischer Edelstahl ist nickelfrei, gut formbar und kann in Anwendungsbereichen mit h&ouml;heren Temperaturen verwendet werden. <iframe width=\"\"640\"\" height=\"\"360\"\" src=\"\"https://www.youtube.com/embed/1Zt7e8vYEZc\"\" frameborder=\"\"0\"\" allow=\"\"autoplay; encrypted-media\"\" allowfullscreen></iframe>\"\"\";\"<p><strong>(!) Maximum order quantity: 1 package</strong><br><br></p><p>Toll costs (6.50 &euro;/t) are included in product price</p>\";\"<p><strong>(!) Maximale Bestellmenge: 1 Paket</strong><br><br></p><p>Mautkosten (6,50 &euro;/t) sind im Produktpreis enthalten</p>\";\"PK\";;\"KGM\";\"my_vendor_stockSheets\";\"4.0\";1250;2500;;1250;;\"rangemy_vendor_Supra\";\"gradeEN_1_4404_1_4401\";\"finish_2B\";\"gradeASTM_316,gradeASTM_316L\";\"standardsApproval_EN_10028_7,standardsApproval_EN_10088_2, standardsApproval_EN_10088_4\";;\"foiling_no\";\"interleavingPaper_yes\";\"marking_yes\";;;;\"approved\";;;2;\"my_vendor_4404_Supra_T4.0_W1250-L2500_2B_with_interleaving_paper\"\n"
			+ ";\"best_steel_T3.0_W1500-L3000_2B_321479\";\"my_vendor_best_steel_T3.0_W1500-L3000_2B_321479\";\"Core 304/4301 - 2B sheet\";\"Core 304/4301 - 2B Blech\";\"<span style=\"\"color: #009ee8\"\">Core 304/4307</span><br><span style=\"\"color: #009ee8\"\"> </span>\";\"<span style=\"\"color: #009ee8\"\">Core 304/4307</span><br><span style=\"\"color: #009ee8\"\"> </span>\";\"<p>Exact delivery cost will be shown in checkout-process and depends on order quantity</p><p><strong>Outokumpu Core range</strong></p>  <ul> <li>Stainless steels for corrosive environments (PRE 17 to 22)</li> <li>Austenitics are highly formable and weldable and are suitable for everything from cutlery to storage tanks</li> <li>Contains the all-purpose Core 304/4307 and Core 304L/4307, as well as several alternatives, including low-nickel and nickel-free products</li> <li>Ferritic stainless steels are nickel free, have good formability, and are used in architectural applications and appliances</li> </ul>  <iframe width=\"\"640\"\" height=\"\"360\"\" src=\"\"https://www.youtube.com/embed/X77-X6cYs1E\"\" frameborder=\"\"0\"\" allow=\"\"autoplay; encrypted-media\"\" allowfullscreen></iframe>\"\"\";\"<p>Genauer Lieferpreis wird im Checkout-Prozess angezeigt und h&auml;ngt von Bestellmenge ab</p> <p><strong>Outokumpu Core Kategorie</strong></p>  <ul> <li>F&uuml;r durchschnittlich korrosive Umgebungen (PRE 17 bis 22).</li> <li>Enth&auml;lt das renommierte Produkt Core 304L/4307 sowie Alternativen.</li> <li>Austenitische G&uuml;ten sind ausgezeichnet form- und schwei&szlig;bar und werden f&uuml;r Haushaltsger&auml;te, Rohre und Lagerbeh&auml;lter verwendet.</li> <li>Ferritischer Edelstahl ist nickelfrei, gut formbar und wird f&uuml;r Anwendungen in der Architektur sowie f&uuml;r Haushaltsger&auml;te verwendet. </li> </ul>  <iframe width=\"\"640\"\" height=\"\"360\"\" src=\"\"https://www.youtube.com/embed/X77-X6cYs1E\"\" frameborder=\"\"0\"\" allow=\"\"autoplay; encrypted-media\"\" allowfullscreen></iframe>\"\"\";\"<p><strong>(!) Maximum order quantity: 1 package</strong><br><br></p><p>Toll costs (6.50 &euro;/t) are included in product price</p>\";\"<p><strong>(!) Maximale Bestellmenge: 1 Paket</strong><br><br></p><p>Mautkosten (6,50 &euro;/t) sind im Produktpreis enthalten</p>\";\"PK\";;\"KGM\";\"my_vendor_stockSheets\";\"3.0\";1500;3000;;1500;;\"rangemy_vendor_Core\";\"gradeEN_1_4301_1_4307\";\"finish_2B\";\"gradeASTM_304,gradeASTM_304L\";\"standardsApproval_EN_10028_7,standardsApproval_EN_10088_2, standardsApproval_EN_10088_4\";;\"foiling_no\";\"interleavingPaper_yes\";\"marking_yes\";;;;\"approved\";;;2;\"my_vendor_best_steel_T3.0_W1500-L3000_2B_with_interleaving_paper\"\n"
			+ ";\"4841_Therma_T4.0_W1000-L2000_1D_279557\";\"my_vendor_4841_Therma_T4.0_W1000-L2000_1D_279557\";\"Therma 314/4841 - 1D sheet\";\"Therma 314/4841 - 1D Blech\";\"<span style=\"\"color: #e40134\"\"> Therma 314/4841 </span> <br/> <span style=\"\"color: #e40134\"\"> </span>\";\"<span style=\"\"color: #e40134\"\"> Therma 314/4841 </span> <br/> <span style=\"\"color: #e40134\"\"> </span>\";\"<p>Exact delivery cost will be shown in checkout-process and depends on order quantity</p><p><strong>Outokumpu Therma range</strong></p> <strong><span style=\"\"color: #e40134\"\"> Therma </span></strong> <br> An austenitic stainless steel with excellent oxidation and creep resistance in cyclic conditions that is best employed in temperatures up to 1150°C/2100°F. There is a slight susceptibility to embrittlement during continuous operation between 600–850°C/1110–1560°F.<br> <p><strong>Typical applications:</strong></p> <li>Furnace equipment (especially supporting parts)</li> <li>Annealing and hardening boxes</li> <li>Air heaters</li> <li>Exhaust systems</li> <li>Automotive components such as turbochargers</li> <li>Valves and flanges</li> </ul> <p><iframe allow=\"\"autoplay; encrypted-media\"\" allowfullscreen=\"\"\"\" frameborder=\"\"0\"\" height=\"\"360\"\" src=\"\"https://www.youtube.com/embed/_A8ui76XHjo\"\" width=\"\"640\"\"></iframe></p>\";\"<p>Genauer Lieferpreis wird im Checkout-Prozess angezeigt und h&auml;ngt von Bestellmenge ab</p> <p><strong>Outokumpu Therma Kategorie</strong></p> <strong><span style=\"\"color: #e40134\"\"> Therma </span></strong> <br> Austenitischer Edelstahl mit ausgezeichneter Oxidations- und Kriechbest&auml;ndigkeit unter zyklischen Bedingungen, der sich bestens f&uuml;r Temperaturen von bis zu 1150 °C eignet. Bei einem kontinuierlichen Einsatz zwischen 600 und 850 °C besteht eine leichte Anf&auml;lligkeit f&uuml;r Verspr&ouml;dung.<br> <p><strong>Typische Anwendungsbereiche:</strong></p> <li>Ofenanlagen (insbesondere tragende Teile)</li> <li>Gl&uuml;hk&auml;sten and H&auml;rtek&auml;sten</li> <li>Lufterhitzer</li> <li>Abgassysteme</li> <li>Automobil-Zubeh&ouml;rteile wie Turbolader</li> <li>Flansche und Ventile</li> </ul> <p><iframe allow=\"\"autoplay; encrypted-media\"\" allowfullscreen=\"\"\"\" frameborder=\"\"0\"\" height=\"\"360\"\" src=\"\"https://www.youtube.com/embed/_A8ui76XHjo\"\" width=\"\"640\"\"></iframe></p>\";\"<p><strong>(!) Maximum order quantity: 1 package</strong><br><br></p><p>Toll costs (6.50 &euro;/t) are included in product price</p>\";\"<p><strong>(!) Maximale Bestellmenge: 1 Paket</strong><br><br></p><p>Mautkosten (6,50 &euro;/t) sind im Produktpreis enthalten</p>\";\"PK\";;\"KGM\";\"my_vendor_stockSheets\";\"4.0\";1000;2000;;1000;;\"rangemy_vendor_Therma\";\"gradeEN_1_4841\";\"finish_1D\";\"gradeASTM_314\";\"standardsApproval_EN_10095\";;\"foiling_no\";\"interleavingPaper_no\";\"marking_yes\";;;;\"unapproved\";;;2;\"my_vendor_4841_Therma_T4.0_W1000-L2000_1D\"\n"
			+ ";\"best_steel_T1.5_W1500-L3000_2B_321646\";\"my_vendor_best_steel_T1.5_W1500-L3000_2B_321646\";\"Core 304/4301 - 2B sheet\";\"Core 304/4301 - 2B Blech\";\"<span style=\"\"color: #009ee8\"\">Core 304/4307</span><br><span style=\"\"color: #009ee8\"\"> </span>\";\"<span style=\"\"color: #009ee8\"\">Core 304/4307</span><br><span style=\"\"color: #009ee8\"\"> </span>\";\"<p>Exact delivery cost will be shown in checkout-process and depends on order quantity</p><p><strong>Outokumpu Core range</strong></p>  <ul> <li>Stainless steels for corrosive environments (PRE 17 to 22)</li> <li>Austenitics are highly formable and weldable and are suitable for everything from cutlery to storage tanks</li> <li>Contains the all-purpose Core 304/4307 and Core 304L/4307, as well as several alternatives, including low-nickel and nickel-free products</li> <li>Ferritic stainless steels are nickel free, have good formability, and are used in architectural applications and appliances</li> </ul>  <iframe width=\"\"640\"\" height=\"\"360\"\" src=\"\"https://www.youtube.com/embed/X77-X6cYs1E\"\" frameborder=\"\"0\"\" allow=\"\"autoplay; encrypted-media\"\" allowfullscreen></iframe>\"\"\";\"<p>Genauer Lieferpreis wird im Checkout-Prozess angezeigt und h&auml;ngt von Bestellmenge ab</p> <p><strong>Outokumpu Core Kategorie</strong></p>  <ul> <li>F&uuml;r durchschnittlich korrosive Umgebungen (PRE 17 bis 22).</li> <li>Enth&auml;lt das renommierte Produkt Core 304L/4307 sowie Alternativen.</li> <li>Austenitische G&uuml;ten sind ausgezeichnet form- und schwei&szlig;bar und werden f&uuml;r Haushaltsger&auml;te, Rohre und Lagerbeh&auml;lter verwendet.</li> <li>Ferritischer Edelstahl ist nickelfrei, gut formbar und wird f&uuml;r Anwendungen in der Architektur sowie f&uuml;r Haushaltsger&auml;te verwendet. </li> </ul>  <iframe width=\"\"640\"\" height=\"\"360\"\" src=\"\"https://www.youtube.com/embed/X77-X6cYs1E\"\" frameborder=\"\"0\"\" allow=\"\"autoplay; encrypted-media\"\" allowfullscreen></iframe>\"\"\";\"<p><strong>(!) Maximum order quantity: 1 package</strong><br><br></p><p>Toll costs (6.50 &euro;/t) are included in product price</p>\";\"<p><strong>(!) Maximale Bestellmenge: 1 Paket</strong><br><br></p><p>Mautkosten (6,50 &euro;/t) sind im Produktpreis enthalten</p>\";\"PK\";;\"KGM\";\"my_vendor_stockSheets\";\"1.5\";1500;3000;;1500;;\"rangemy_vendor_Core\";\"gradeEN_1_4301_1_4307\";\"finish_2B\";\"gradeASTM_304,gradeASTM_304L\";\"standardsApproval_EN_10028_7,standardsApproval_EN_10088_2, standardsApproval_EN_10088_4\";;\"foiling_no\";\"interleavingPaper_yes\";\"marking_yes\";;;;\"approved\";;;2;\"my_vendor_best_steel_T1.5_W1500-L3000_2B_with_interleaving_paper\"\n"
			+ ";\"best_steel_T2.5_W2000-L4000_2B_319386\";\"my_vendor_best_steel_T2.5_W2000-L4000_2B_319386\";\"Core 304/4301 - 2B sheet\";\"Core 304/4301 - 2B Blech\";\"<span style=\"\"color: #009ee8\"\">Core 304/4307</span><br><span style=\"\"color: #009ee8\"\"> </span>\";\"<span style=\"\"color: #009ee8\"\">Core 304/4307</span><br><span style=\"\"color: #009ee8\"\"> </span>\";\"<p>Exact delivery cost will be shown in checkout-process and depends on order quantity</p><p><strong>Outokumpu Core range</strong></p>  <ul> <li>Stainless steels for corrosive environments (PRE 17 to 22)</li> <li>Austenitics are highly formable and weldable and are suitable for everything from cutlery to storage tanks</li> <li>Contains the all-purpose Core 304/4307 and Core 304L/4307, as well as several alternatives, including low-nickel and nickel-free products</li> <li>Ferritic stainless steels are nickel free, have good formability, and are used in architectural applications and appliances</li> </ul>  <iframe width=\"\"640\"\" height=\"\"360\"\" src=\"\"https://www.youtube.com/embed/X77-X6cYs1E\"\" frameborder=\"\"0\"\" allow=\"\"autoplay; encrypted-media\"\" allowfullscreen></iframe>\"\"\";\"<p>Genauer Lieferpreis wird im Checkout-Prozess angezeigt und h&auml;ngt von Bestellmenge ab</p> <p><strong>Outokumpu Core Kategorie</strong></p>  <ul> <li>F&uuml;r durchschnittlich korrosive Umgebungen (PRE 17 bis 22).</li> <li>Enth&auml;lt das renommierte Produkt Core 304L/4307 sowie Alternativen.</li> <li>Austenitische G&uuml;ten sind ausgezeichnet form- und schwei&szlig;bar und werden f&uuml;r Haushaltsger&auml;te, Rohre und Lagerbeh&auml;lter verwendet.</li> <li>Ferritischer Edelstahl ist nickelfrei, gut formbar und wird f&uuml;r Anwendungen in der Architektur sowie f&uuml;r Haushaltsger&auml;te verwendet. </li> </ul>  <iframe width=\"\"640\"\" height=\"\"360\"\" src=\"\"https://www.youtube.com/embed/X77-X6cYs1E\"\" frameborder=\"\"0\"\" allow=\"\"autoplay; encrypted-media\"\" allowfullscreen></iframe>\"\"\";\"<p><strong>(!) Maximum order quantity: 1 package</strong><br><br></p><p>Toll costs (6.50 &euro;/t) are included in product price</p>\";\"<p><strong>(!) Maximale Bestellmenge: 1 Paket</strong><br><br></p><p>Mautkosten (6,50 &euro;/t) sind im Produktpreis enthalten</p>\";\"PK\";;\"KGM\";\"my_vendor_stockSheets\";\"2.5\";2000;4000;;2000;;\"rangemy_vendor_Core\";\"gradeEN_1_4301_1_4307\";\"finish_2B\";\"gradeASTM_304,gradeASTM_304L\";\"standardsApproval_EN_10028_7,standardsApproval_EN_10088_2, standardsApproval_EN_10088_4\";;\"foiling_no\";\"interleavingPaper_yes\";\"marking_yes\";;;;\"unapproved\";;;2;\"my_vendor_best_steel_T2.5_W2000-L4000_2B_with_interleaving_paper\"\n"
			+ ";\"best_steel_T1.0_W1000-L2000_2B_321638\";\"my_vendor_best_steel_T1.0_W1000-L2000_2B_321638\";\"Core 304/4301 - 2B sheet\";\"Core 304/4301 - 2B Blech\";\"<span style=\"\"color: #009ee8\"\">Core 304/4307</span><br><span style=\"\"color: #009ee8\"\"> </span>\";\"<span style=\"\"color: #009ee8\"\">Core 304/4307</span><br><span style=\"\"color: #009ee8\"\"> </span>\";\"<p>Exact delivery cost will be shown in checkout-process and depends on order quantity</p><p><strong>Outokumpu Core range</strong></p>  <ul> <li>Stainless steels for corrosive environments (PRE 17 to 22)</li> <li>Austenitics are highly formable and weldable and are suitable for everything from cutlery to storage tanks</li> <li>Contains the all-purpose Core 304/4307 and Core 304L/4307, as well as several alternatives, including low-nickel and nickel-free products</li> <li>Ferritic stainless steels are nickel free, have good formability, and are used in architectural applications and appliances</li> </ul>  <iframe width=\"\"640\"\" height=\"\"360\"\" src=\"\"https://www.youtube.com/embed/X77-X6cYs1E\"\" frameborder=\"\"0\"\" allow=\"\"autoplay; encrypted-media\"\" allowfullscreen></iframe>\"\"\";\"<p>Genauer Lieferpreis wird im Checkout-Prozess angezeigt und h&auml;ngt von Bestellmenge ab</p> <p><strong>Outokumpu Core Kategorie</strong></p>  <ul> <li>F&uuml;r durchschnittlich korrosive Umgebungen (PRE 17 bis 22).</li> <li>Enth&auml;lt das renommierte Produkt Core 304L/4307 sowie Alternativen.</li> <li>Austenitische G&uuml;ten sind ausgezeichnet form- und schwei&szlig;bar und werden f&uuml;r Haushaltsger&auml;te, Rohre und Lagerbeh&auml;lter verwendet.</li> <li>Ferritischer Edelstahl ist nickelfrei, gut formbar und wird f&uuml;r Anwendungen in der Architektur sowie f&uuml;r Haushaltsger&auml;te verwendet. </li> </ul>  <iframe width=\"\"640\"\" height=\"\"360\"\" src=\"\"https://www.youtube.com/embed/X77-X6cYs1E\"\" frameborder=\"\"0\"\" allow=\"\"autoplay; encrypted-media\"\" allowfullscreen></iframe>\"\"\";\"<p><strong>(!) Maximum order quantity: 1 package</strong><br><br></p><p>Toll costs (6.50 &euro;/t) are included in product price</p>\";\"<p><strong>(!) Maximale Bestellmenge: 1 Paket</strong><br><br></p><p>Mautkosten (6,50 &euro;/t) sind im Produktpreis enthalten</p>\";\"PK\";;\"KGM\";\"my_vendor_stockSheets\";\"1.0\";1000;2000;;1000;;\"rangemy_vendor_Core\";\"gradeEN_1_4301_1_4307\";\"finish_2B\";\"gradeASTM_304,gradeASTM_304L\";\"standardsApproval_EN_10028_7,standardsApproval_EN_10088_2, standardsApproval_EN_10088_4\";;\"foiling_no\";\"interleavingPaper_yes\";\"marking_yes\";;;;\"approved\";;;2;\"my_vendor_best_steel_T1.0_W1000-L2000_2B_with_interleaving_paper\"";
